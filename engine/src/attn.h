...
void LaunchAttnPrefill(const __nv_bfloat16* q,
...
void LaunchAttnDecode(const __nv_bfloat16* qkv,
                      const __nv_bfloat16* cache_kv, __nv_bfloat16* out,
                      const int* pos, const int* qstart, const int* decode_rids,
                      int n_decode, const int* bt, int max_blocks, float* pm,
                      float* pl, float* pa, cudaStream_t s);
